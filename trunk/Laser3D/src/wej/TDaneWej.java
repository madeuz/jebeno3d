...
public class TDaneWej implements IBlock {
   ...
   public JComponent getJComponent() {
      ...
      //2. Dodanie ustawie� poczatkowych
      jp.add(getSetP());
...
public class TDaneWej extends TAbstBlock {
    ...
    public void checkSettings() //spr. i pobiera ustawienia poczatkowe
    {
        ...
        //Spr. ustawienia pocz�tkowe nast�pnego modu�u
    ...
    public void createObjFile(String aName) {
        ...
        //3. Przekazuj� nast�pnym obiektom nazw� pliku
        ...
        try {
            ...
            if (lLineAL.size() > 1) {
                ...
                for (int i=0; i<linT.length; i++) {
                    ...
                    if(lXyzAL.size() == 0) //ignoruj� t� lini� (np. ## Player version 1.6.5 )
                        continue;
